...
static NSString *const LINK_COORDINATE_SEARCH_WEATHER = @"http://api.openweathermap.org/data/2.5/forecast";
static NSString *const appID = @"appid=802605eed9934b3c4e0a133a7953fd76";
